...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void carregarTabela() {
        ...
        DefaultTableModel model = (DefaultTableModel) tableTabela.getModel(); // substitua 'suaTabela' pelo nome real da JTable
        ...
        for (ProdutosDTO produto : lista) {
            model.addRow(new Object[]{
                ...
                produto.getNome(),
                produto.getValor()
            // Adicione aqui mais colunas conforme sua tabela tiver
            });
        }
    }
